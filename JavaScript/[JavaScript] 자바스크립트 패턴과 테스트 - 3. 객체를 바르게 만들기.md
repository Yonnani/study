...
- 함수형 상속(functional inheritance)을 하면 데이터를 숨긴 채 접근을 다스릴 수 있음
...
AnimalKingdom.marsupial = function(name, nocturnal) {
    ...
    return {
        getName: function() { return instanceName; },
        getIsNocturnal: function() { return instanceIsNocturnal; }
    };
};

AnimalKingdom.kangaroo = fuction(name) {
